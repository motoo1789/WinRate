...
//	private String nemesis;
	...
	private String youwin_min = "C:\\pleiades\\workspace\\WinRate2\\youwin_min.bmp";
	...
	public TemplateMatching_Leader() {
		...
		leader[0] = "C:\\pleiades\\workspace\\WinRate2\\elf.bmp";
		leader[1] = "C:\\pleiades\\workspace\\WinRate2\\royal.bmp";
		leader[2] = "C:\\pleiades\\workspace\\WinRate2\\witch.bmp";
		leader[3] = "C:\\pleiades\\workspace\\WinRate2\\dragon.bmp";
		leader[4] = "C:\\pleiades\\workspace\\WinRate2\\nekura.bmp";
		leader[5] = "C:\\pleiades\\workspace\\WinRate2\\vampire.bmp";
		leader[6] = "C:\\pleiades\\workspace\\WinRate2\\bishop.bmp";
		leader[7] = "C:\\pleiades\\workspace\\WinRate2\\nemesis.bmp";
		...
		*/
		temp = Imgcodecs.imread(youwin_min, Imgcodecs.IMREAD_COLOR);
	...
	public int Leader_Maching()
	{
		...
		{
			temp = Imgcodecs.imread(leader[num], Imgcodecs.IMREAD_COLOR);
			//System.out.println("リーダーマッチングメソッド内 num=" + num);
...
/*
	...
	public int Leader_Maching()
	{
		...
		{
			System.out.println("リーダーマッチングメソッド内 num=" + num);
			Imgproc.matchTemplate(image, tmp[num], result, Imgproc.TM_CCOEFF_NORMED);
			Imgproc.threshold(result, result, 0.8, 1.0, Imgproc.THRESH_TOZERO);
