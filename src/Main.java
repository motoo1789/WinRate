...
public class Main extends Application
{
	...
	private Text save_text = new Text("保存");
	...
	public void start(Stage stage)throws Exception
	{
		...
		*/
		...
		save_bt.setOnAction(new kyaputyaEventHandler_save());
	...
	public class kyaputyaEventHandler_save implements EventHandler<ActionEvent>
	{
		@Override
		public void handle(ActionEvent event) {
			cap3.save();
